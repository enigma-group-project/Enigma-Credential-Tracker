...
contract InvariantTest is Test {
    ...
    /// @dev Authorization property: a non-Institution can NEVER issue, for any inputs.
    function testFuzz_OnlyTestCenterCanIssue(address caller, bytes32 id, bytes32 h, address owner_) public {
        ...
        vm.assume(!issuers.isInstitution(caller));
        vm.prank(caller);
        vm.expectRevert(RecordRegistry.NotInstitution.selector);
        records.issueCredential(id, h, "cid", owner_, "meta");
    }
